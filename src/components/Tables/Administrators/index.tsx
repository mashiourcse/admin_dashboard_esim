...
import { Table, Button, Space, ConfigProvider, Modal, Card, Row, Form, Input, message } from 'antd';
import { EditOutlined, DeleteOutlined, InfoCircleOutlined, CopyOutlined } from '@ant-design/icons';
  ...
  const columns: (UserColumn | ActionColumn)[] = [
    ...
    },
    {
      ...
      render: (_: any, record: UserData) => (
        <Space size="middle">
          <Button type="link" icon={<InfoCircleOutlined />} onClick={() => handleInfoClick(record)} />
  ...
  return (
    <ConfigProvider theme={antTheme}>
      ...
      >
        {modalData && formData && (
          <Card
            title={<span style={{ fontWeight: 'bold' }}>{isEditing ? 'Edit User' : formData.name}</span>}
            bordered={true}
          ...
          >
            <Form layout="vertical">
              <Form.Item label={<span style={{ fontWeight: 'bold' }}>User Name</span>}>
                <Input
                  name="name"
                  value={formData.name}
                  readOnly={!isEditing}
              ...
              <Form.Item label={<span style={{ fontWeight: 'bold' }}>Email Address</span>}>
              ...
              <Form.Item label={<span style={{ fontWeight: 'bold' }}>Phone Number</span>}>
                <Input
                  name="phoneNumber"
